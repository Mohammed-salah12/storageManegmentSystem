                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name"
                                                   value="{{ $locations->name ?? "" }}" placeholder="Enter name of Admin">
                                        </div>

                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label for="description">name of Admin</label>
                                                <input type="text" class="form-control" id="description" name="description"
                                                       value="{{ $locations->description ?? "" }}" placeholder="Enter name of Admin">
                                            </div>
                                    ...
                                    <div class="card-footer">
                                        <button type="button" onclick="performUpdate({{$locations->id}})" class="btn btn-primary">update</button>
...
@section('scripts')
    <script>
        function performUpdate(id) {
            ...
            storeRoute('/dashboard/update-locations/' + id, formData);
        }
    </script>
@endsection
